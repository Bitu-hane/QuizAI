...
const clientId = import.meta.env.VITE_GOOGLE_CLIENT_ID || '614776096538-1g47284qqu6sdpva8he9ubtomk07htv7.apps.googleusercontent.com';

  if (!clientId) {
    console.warn('⚠️ Missing VITE_GOOGLE_CLIENT_ID in environment variables');
  }
    ...
    <GoogleOAuthProvider clientId={clientId || ''}>
      <Box className="login-page">
        ...
        <Paper className="login-card">
          ...
          {/* ✅ Show the GoogleLogin component directly */}
